The main purpose for this program is to detect if an object is a jellyfish or not. This project was based on a research to prevent the dangers of jellyfish in a tourist area.
